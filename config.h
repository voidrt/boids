...
#define BOID_TO_WHOID_SEPARATION_STRENGTH 3.7f
...
#define WHOID_SEPARATION_RADIUS 600
#define WHOID_SEPARATION_STRENGTH 10.0f
#define EDGE_AVOIDANCE_STRENGTH 0.7f
